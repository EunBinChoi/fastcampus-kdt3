...
class InstrumentationSupport {
    ...
    private static final boolean TRY_INSTALL_ATTACH = !Boolean.getBoolean("jol.skipInstallAttach");
    private static final boolean TRY_DYNAMIC_ATTACH = !Boolean.getBoolean("jol.skipDynamicAttach");
