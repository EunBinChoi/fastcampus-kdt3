...
<script>
    ...
    function randomColor() {
        ...
        $('#header__locale').css("background-color", bgColor);
...
<header>
    <div class="header">
        ...
        <ul class="header__nav">
            ...
            <li><a href="/">${message.INDEX_MENU_HOME}</a></li>
            <li><a href="/members/search">${message.INDEX_MENU_SEARCH}</a></li>
            <li><a href="/members/survey">${message.INDEX_MENU_SURVEY}</a></li>
        </ul>
