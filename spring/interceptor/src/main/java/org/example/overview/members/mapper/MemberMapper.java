...
public interface MemberMapper {
    ...
    List<Member> searchMember(@Param("q") String q);
    ...
    @Select("select * from new_member as a join new_survey as b on a.survey_id = b.survey_id " +
            "where user_id = #{uId}")
    Member selectWithSurvey(@Param("uId") String uId);
    ...
    Survey selectSurvey(@Param("sId") BigInteger sId);
    ...
    int insertMember(@Param("newMember") Member newMember);
